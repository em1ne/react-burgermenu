...
const HeadlineCards = () => {
    return (
        <div className='max-w-[1640px] mx-auto p-4 py-12 md:grid-cols-3 gap-6'>
            {/* Card */}
            <div className='rounded-xl relative'>
                {/* Overlay */}
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                    <p className='font-bold text-2c-xl px-2 pt-4'>Sun's Out, BOGO's Out</p>
            ...
            <div className='rounded-xl relative'>
                {/* Overlay */}
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                    <p className='font-bold text-2c-xl px-2 pt-4'>New Restaurant</p>
            ...
            <div className='rounded-xl relative'>
                {/* Overlay */}
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                    <p className='font-bold text-2c-xl px-2 pt-4'>we Deliver Desserts Too</p>
